  ...
  <q-page>
    <div class="q-pa-md">
      ...
      >
        ...
        <span class="text-blue-grey-14">Data Transaksi Optic Genta</span>
      </span>
          <q-space />
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'typekacamata', align: 'center', label: 'Tipe Kaca Mata', field: 'typekacamata', sortable: true },
      ...
      data: [
        {
          ...
          namapembeli: 'Amir',
          typekacamata: ' Dior Frame Bulat Silver (Lensa putih) ',
          hargakacamata: ' Rp.350000 ',
          jumlahbeli: 1,
          total: '350000'
        },
        {
          ...
          namapembeli: 'Mutiara',
          typekacamata: ' Dior Frame Bulat Hitam (Lensa Photocromic) ',
          hargakacamata: ' Rp.950000 ',
          jumlahbeli: 1,
          total: '950000'
        },
        {
          ...
          namapembeli: 'Atika',
          typekacamata: ' Dior Frame Persegi Hitam (Lensa Photocromic) ',
          hargakacamata: ' Rp.850000 ',
          jumlahbeli: 1,
          total: '850000'
        }
      ]
